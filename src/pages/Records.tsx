...
function getIconInfo(record: HealthRecord): IconInfo {
  ...
  if (record.record_type === "visit")
    return { icon: <Activity size={20} />, bg: "#f5f0eb", color: "#8b7355", gradient: "linear-gradient(135deg, #a29bfe 0%, #6c5ce7 100%)" };
          ...
          <div className="h3d-hero-text">
            ...
            {currentPet && (
              <button className="h3d-pet-btn" onClick={() => navigate("/app")}>
                <span className="h3d-pet-emoji">{petEmoji(currentPet.species)}</span>
      ...
      <section className="h3d-stats-section">
        <div className="h3d-weight-card">
          <div className="h3d-weight-header">
            ...
            <button className="h3d-add-record-btn" onClick={() => navigate("/app/add-record")}>
              <Plus size={14} />
              <span>添加记录</span>
            </button>
          </div>
        ...
        {loading ? (
          ...
          <div className="h3d-empty-fancy">
            <div className="h3d-empty-3d-scene">
              ...
              {/* 环绕的可爱元素 */}
              <span className="h3d-float-ele h3d-fe-1">📋</span>
              <span className="h3d-float-ele h3d-fe-2">💊</span>
              <span className="h3d-float-ele h3d-fe-3">❤️</span>
              <span className="h3d-float-ele h3d-fe-4">✨</span>
              <span className="h3d-float-ele h3d-fe-5">💉</span>
            </div>

            <div className="h3d-empty-circle">
              <div className="h3d-empty-ring h3d-ring-1" />
              <div className="h3d-empty-ring h3d-ring-2" />
              <div className="h3d-empty-emoji">🏥</div>
            </div>

            <h4 className="h3d-empty-title">暂无健康记录</h4>
            <p className="h3d-empty-desc">
              {currentPet
                ? `${currentPet.name}还没有健康记录哦`
                : "还没有任何健康记录"}
            </p>
            <button className="h3d-empty-btn" onClick={() => navigate("/app/add-record")}>
              <Plus size={14} />
              去添加第一条记录
            </button>
          </div>
                ...
                >
                  ...
                  <div className="h3d-record-content">
                    ...
                    <div className="h3d-record-date">
                      <span className="h3d-record-date-icon">🗓</span>
                      {record.record_date}
                    </div>
                  </div>
